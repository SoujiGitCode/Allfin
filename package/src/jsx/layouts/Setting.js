									...
									<Tab.Pane className="tab-pane fade " eventKey="Theme">
										<div className="admin-settings">
											<div className="row">
												...
												<div className="col-sm-6 primary-setting">
													<p>Primary</p>
													<div>
														{colors.map((color, i) => (
															<span key={i}>
												...
												<div className="col-sm-6 navheader-setting">
												...
												<div className="col-sm-6 header-setting">
													<p>Header</p>
													<div>
														{colors.map((color, i) => (
															<span key={i}>
												...
												<div className="col-sm-6 sidebar-setting">
													<p>Sidebar</p>
													<div>
														{colors.map((color, i) => (
															<span key={i}>
