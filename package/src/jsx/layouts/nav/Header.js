            ...
            <ul className="navbar-nav header-right main-notification">
                    ...
                    <ul className="timeline">
                      ...
                      <li>
                        <div className="timeline-panel">
                          ...
                          <div className="media-body">
                            <h6 className="mb-1">Vencimiento de Prestamo 25251818</h6>
                            <small className="d-block">
                              29 July 2021 - 02:26 PM
                            </small>
                          </div>
                      ...
                      <li>
                        <div className="timeline-panel">
                          ...
                          <div className="media-body">
                            <h6 className="mb-1">
                             Envio de BTC realizado con exito
                            </h6>
                            <small className="d-block">
                      ...
                      <li>
                        <div className="timeline-panel">
                          ...
                          <div className="media-body">
                            <h6 className="mb-1">Recordatorio : Vault Date!</h6>
                            <small className="d-block">
                              29 July 2020 - 02:26 PM
                            </small>
                          </div>
              ...
              <Dropdown as="li" className="nav-item dropdown header-profile">
                <Dropdown.Toggle
                  ...
                  data-toggle="dropdown"
                >
                  <img src={profile} width={20} alt=""  style={{display:"none"}}/>
                  <div className="header-info">
                    <span>Reinaldo</span>
                    <small>Usuario Premium</small>
                  </div>
                </Dropdown.Toggle>
                ...
                <Dropdown.Menu align="right" className="mt-2">
                  ...
                  <Link to="/email-inbox" className="dropdown-item ai-icon" style={{display:"none"}}>
                    <svg
                      id="icon-inbox"
                      xmlns="http://www.w3.org/2000/svg"
